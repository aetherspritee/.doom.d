;;; themes/my-horizon-theme.el -*- lexical-binding: t; -*-
...
(def-doom-theme my-horizon
  ...
  ((bg         '("#161821" nil       nil            ))
   ...
   (grey       base4)
   (red        '("#e27878" "#e95678" "red"          ))
   (orange     '("#e2a478" "#f09383" "brightred"    ))
   (green      '("#b4be82" "#09f7a0" "green"        ))
   (teal       '("#89b8c2" "#87ceeb" "brightgreen"  ))
   (yellow     '("#e9b189" "#fab795" "yellow"       ))
   (blue       '("#84a0c6" "#21bfc2" "brightblue"   ))
   (dark-blue  '("#91acd1" "#25b2bc" "blue"         ))
   (magenta    '("#a093c7" "#6c6f93" "magenta"      ))
   (violet     '("#ada0d3" "#b877db" "brightmagenta"))
   (cyan       '("#95c4ce" "#59e3e3" "brightcyan"   ))
   (dark-cyan  '("#c0ca8e" "#27d797" "cyan"   ))
