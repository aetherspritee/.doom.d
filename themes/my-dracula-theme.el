...
;;
(def-doom-theme my-dracula
  "A dark theme based on Dracula theme"

  ;; name        default   256       16
  ((bg         '("#12131A" "#262626" "black"        ))
   ...
   (orange     '("#e2a478" "#ffbb66" "brightred"    ))
   (green      '("#b4be82" "#55ff77" "green"        ))
   (teal       '("#95c4ce" "#0088cc" "brightgreen"  ))
   (yellow     '("#e9b189" "#ffff88" "yellow"       ))
   (blue       '("#84a0c6" "#66bbff" "brightblue"   ))
   (dark-blue  '("#91acd1" "#0088cc" "blue"         ))
   (magenta    '("#a093c7" "#ff77cc" "magenta"      ))
   (violet     '("#b4be82" "#bb99ff" "brightmagenta"))
   (cyan       '("#89b8c2" "#88eeff" "brightcyan"   ))
   (dark-cyan  '("#89b8c2" "#88eeff" "cyan"         ))
